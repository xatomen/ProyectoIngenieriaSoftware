...
<div class="">
    ...
    <!-- <div class="card">
        <table class="table table-bordered shadow p-5">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Link Imágen</th>
            ...
            <tbody>
                <?php foreach($listaImagenes as $lista) {?>
                    <tr>
                        <th><?php echo $lista['ID_IMG_CARRUSEL'] ?></th>
                        <th><?php echo $lista['IMAGEN_CARRUSEL'] ?></th>
                        <th><?php echo $lista['DESCRIPCION_IMG_CARRUSEL'] ?></th>
                        <th><img src="<?php echo $lista['IMAGEN_CARRUSEL'] ?>" style="max-height:150px;"></th>
                        <th><?php echo $lista['MOSTRAR_IMG_CARRUSEL'] ?></th>
                        <th class="row">
                            <form action="">
                                <div class="row text-center">
                                    <div class="col text-center">
                                        <div class="row">Activar</div>
                                        <div class="row">Desactivar</div>
                                        <div class="row">Subir</div>
                                        <div class="row">Bajar</div>
                                        <div class="row">Editar</div>
                                        <div class="row">Eliminar</div>
                                    </div>
                                </div>
                            </form>
                        </th>
                ...
                <div class="card p-3 shadow">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <form method="POST">
                                    ...
                                    <input type="text" class="form-control" value="" id="exampleFormControlInput1" placeholder="ID" disabled>
                                </form>
                            </div>
                        </div>
                        <div class="col"></div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <form method="POST">
                                    <label for="exampleFormControlInput1" class="form-label">Link imágen</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Ingrese URL">
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST">
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Descripción imágen</label>
