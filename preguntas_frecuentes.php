...
<div class="box m-5">
    ...
    <!-- <div class="columns">
        <div class="box m-5 column">
            <h2 class="title">Pregunta 1</h2>
            <p1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate similique cum ipsam officiis aliquam quae recusandae deserunt nulla, iure qui ducimus eos nesciunt. Expedita iusto velit eum suscipit reprehenderit fugiat?</p1>
        </div>
        <div class="box m-5 column">
            <h2 class="title">Pregunta 2</h2>
            <p1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate similique cum ipsam officiis aliquam quae recusandae deserunt nulla, iure qui ducimus eos nesciunt. Expedita iusto velit eum suscipit reprehenderit fugiat?</p1>
        </div>
        <div class="box m-5 column">
            <h2 class="title">Pregunta 3</h2>
            <p1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate similique cum ipsam officiis aliquam quae recusandae deserunt nulla, iure qui ducimus eos nesciunt. Expedita iusto velit eum suscipit reprehenderit fugiat?</p1>
        </div>
    </div> -->
